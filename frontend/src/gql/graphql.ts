...
export type ProductWithVariants = {
  __typename?: 'ProductWithVariants';
  product?: Maybe<Product>;
  variants?: Maybe<Array<StoreVariant>>;
};
...
export type Query = {
  ...
  getVariantsByStore?: Maybe<StoreVariant>;
...
export type QueryGetVariantsByStoreArgs = {
  storeId: Scalars['Float']['input'];
};
