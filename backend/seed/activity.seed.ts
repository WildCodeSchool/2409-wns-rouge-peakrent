...
export const seedActivities = async () => {
  ...
  const activities = [
    {
      name: "Ski Alpin",
      description: "Glissez sur les pistes avec notre sélection de skis alpins pour tous niveaux. Performance, confort et sensations fortes garanties pour des journées inoubliables à la montagne !",
      urlImage:
    ...
    {
      name: "Snowboard",
      description: "Envie de rider avec style ? Découvrez nos snowboards dernière génération et nos conseils experts pour dévaler les pentes en toute liberté. Plaisir et adrénaline au rendez-vous !",
      urlImage:
    ...
    {
      name: "Raquettes",
      description: "Explorez la montagne autrement avec nos raquettes à neige. Faciles à utiliser, elles vous emmènent hors des sentiers battus pour des balades hivernales magiques et accessibles à tous !",
      urlImage:
    ...
    {
      name: "Chaussures",
      description: "Du sommet au sentier, trouvez la chaussure idéale ! Ski, rando ou ville : confort, technicité et maintien pour affronter tous les terrains avec assurance !",
      urlImage:
    ...
    {
      name: "Vêtements",
      description: "Affrontez les éléments avec style ! Nos vêtements techniques vous protègent du froid, du vent et de la neige tout en garantissant confort et liberté de mouvement. Pour toute la famille !",
      urlImage:
    ...
    {
      name: "Vélos",
      description: "Du VTT au vélo électrique, partez à l'aventure avec nos modèles adaptés à tous les niveaux. Profitez des paysages de montagne comme jamais grâce à un matériel fiable et performant !",
      urlImage:
    ...
    {
      name: "Randonnée",
      description: "Partez à la conquête des sentiers ! Équipez-vous avec nos bâtons, sacs, et accessoires de rando. Confort et sécurité pour vos balades ou vos défis en altitude !",
      urlImage:
