  ...
  const products = [
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/ski-1.jpg`,
      isPublished: true,
      sku: "SKI-001",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/ski-2.jpg`,
      isPublished: true,
      sku: "SKI-002",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/ski-3.jpg`,
      isPublished: true,
      sku: "SKI-003",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/snow-1.jpg`,
      isPublished: true,
      sku: "SNB-001",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/snow-2.jpg`,
      isPublished: true,
      sku: "SNB-002",
    },
    {
    ...
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/raquette-1.jpg`,
      isPublished: true,
      sku: "RAQ-001",
    },
    {
    ...
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/raquette-2.jpg`,
      isPublished: true,
      sku: "RAQ-003",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/chaussures-1.jpg`,
      isPublished: true,
      sku: "CHS-001",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/chaussures-2.jpg`,
      isPublished: true,
      sku: "CHS-002",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/chaussures-3.jpg`,
      isPublished: true,
      sku: "CHS-003",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/veste.jpg`,
      isPublished: true,
      sku: "VET-001",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/pantalon.jpg`,
      isPublished: true,
      sku: "VET-002",
    },
    {
      ...
      urlImage: `${process.env.NGINX_URL}/rest/uploads/static/combi.jpg`,
      isPublished: true,
      sku: "VET-003",
    },
  ];
